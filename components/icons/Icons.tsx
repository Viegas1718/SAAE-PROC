...
// Using Heroicons v2 library as a base for consistency and aesthetics.

export const InboxIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M10 15h4M7.5 7.5h9" />
  </svg>
);
...
export const ArchiveBoxIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5a2.25 2.25 0 0 0 2.25-2.25V7.5A2.25 2.25 0 0 0 20.25 5.25H3.75A2.25 2.25 0 0 0 1.5 7.5v11.25A2.25 2.25 0 0 0 3.75 21Zm12-10.5a.75.75 0 0 0-1.5 0v4.5a.75.75 0 0 0 1.5 0v-4.5Z" />
  </svg>
);
...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.57-1.023.995-2.147 1.256-3.375a4.5 4.5 0 0 0-4.88-4.88C5.038 7.555 4.5 8.162 4.5 9.75v8.25c0 .414.336.75.75.75h7.5a.75.75 0 0 0 .75-.75v-2.25m0-4.5c-.628 1.03-1.256 2.138-1.95 3.286m-4.417-4.417c.328-1.12.738-2.15 1.256-3.138a4.5 4.5 0 0 1 4.88-4.88c.997 0 1.953.283 2.753.811m-3.478 3.478c1.023.57 2.147.995 3.375 1.256m2.25-2.25.386.386m-2.636 2.636.386.386m2.25-2.25-2.636 2.636" />
    </svg>
);
...
export const LockOpenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75M10.5 21.75h9a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25h-9a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
  </svg>
);
...
export const DevicePhoneMobileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75A2.25 2.25 0 0 0 15.75 1.5h-2.25m-3 0h3m-3.75 6.75h.007v.008h-.007v-.008Zm0 0h3.75" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226a9 9 0 1 1-2.12 14.536c-.55-.223-1.02-.684-1.11-1.226L6.08 13.982a7.5 7.5 0 0 0 10.824 0l-1.13-2.548c-.09-.203-.31-.32-.53-.32h-3.403a.5.5 0 0 1-.447-.724l1.13-2.548a.5.5 0 0 0-.285-.815H9.594Z" />
  </svg>
);
// FIX: Added missing EllipsisVerticalIcon, ArrowDownOnSquareIcon, and XMarkIcon icons.
